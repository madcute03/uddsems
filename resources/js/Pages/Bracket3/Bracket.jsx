    ...
    const handleClick = (matchId, playerKey) => {
        ...
        if (p1.name !== "TBD" && p2.name !== "TBD") {
            if (p1.score !== p2.score) {
                ...
                switch (matchId) {
                    case "UB1":
                        updated.UB2.p2 = { ...updated.UB2.p2, name: updated[matchId].winner, score: 0 };
                    ...
                    case "UB2":
                        ...
                        break;
                    case "LB1":
                        updated.GF.p2 = { ...updated.GF.p2, name: updated[matchId].winner, score: 0 };
                        break;
                    case "GF":
                        setChampion(updated[matchId].winner);
                        break;
                }
            }
        }
