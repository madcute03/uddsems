...
export default function EightTeamDoubleElimination() {
            ...
            <div id="bracket-container" className="relative">
                ...
                <div>
                    ...
                    <div className="flex gap-12 mb-10">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-center">Quarterfinal</h3>
                            <div className="flex flex-col">
                                <div>{renderMatch("UB5")}</div>
                                <div className="mt-20">{renderMatch("UB6")}</div> {/* added top gap */}
                            </div>
                        </div>
