...
export default function FiveTeamDoubleElimination() {
    ...
    const handleClick = (matchId, playerKey) => {
        ...
        if (p1.name !== "TBD" && p2.name !== "TBD") {
            if (p1.score !== p2.score) {
                ...
                updated[matchId].winner = updated[matchId][winnerKey].name;
                updated[matchId].loser = updated[matchId][loserKey].name;

                // Upper Bracket
                if (matchId === "UB1") {
                    updated.UB3.p2 = { ...updated.UB3.p2, name: updated[matchId].winner, score: 0 };
                    updated.LB1.p1 = { ...updated.LB1.p1, name: updated[matchId].loser, score: 0 };
                }
                if (matchId === "UB2") {
                    updated.UB4.p1 = { ...updated.UB4.p1, name: updated[matchId].winner, score: 0 };
                    updated.LB1.p2 = { ...updated.LB1.p2, name: updated[matchId].loser, score: 0 };
                }
                if (matchId === "UB3") {
                    updated.UB4.p2 = { ...updated.UB4.p2, name: updated[matchId].winner, score: 0 };
                    updated.LB2.p1 = { ...updated.LB2.p1, name: updated[matchId].loser, score: 0 };
                }
                if (matchId === "UB4") {
                    updated.GF.p1 = { ...updated.GF.p1, name: updated[matchId].winner, score: 0 };
                    updated.LB3.p2 = { ...updated.LB3.p2, name: updated[matchId].loser, score: 0 };
                }

                // Lower Bracket
                if (matchId === "LB1") updated.LB2.p2 = { ...updated.LB2.p2, name: updated[matchId].winner, score: 0 };
                if (matchId === "LB2") updated.LB3.p1 = { ...updated.LB3.p1, name: updated[matchId].winner, score: 0 };
                if (matchId === "LB3") updated.GF.p2 = { ...updated.GF.p2, name: updated[matchId].winner, score: 0 };

                // Grand Final
                if (matchId === "GF") setChampion(updated[matchId].winner);
            }
        }
    ...
    return (
        <div className="bg-gray-900 min-h-screen p-6 text-white">
            <h1 className="text-2xl font-bold text-center mb-6">
                5-Team Double Elimination Bracket with Rounds
            </h1>
