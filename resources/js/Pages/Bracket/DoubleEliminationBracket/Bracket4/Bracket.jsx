    ...
    const handleClick = (matchId, playerKey) => {
        ...
        if (p1.name !== "TBD" && p2.name !== "TBD") {
            if (p1.score !== p2.score) {
                ...
                // Upper Bracket
                if (matchId === "UB1") {
                    updated.UB3.p1 = { ...updated.UB3.p1, name: updated[matchId].winner, score: 0 };
                ...
                if (matchId === "UB3") {
                    ...
                    updated.LB2.p2 = { ...updated.LB2.p2, name: updated[matchId].loser, score: 0 };
                }

                // Lower Bracket
                if (matchId === "LB1") updated.LB2.p1 = { ...updated.LB2.p1, name: updated[matchId].winner, score: 0 };
                if (matchId === "LB2") updated.GF.p2 = { ...updated.GF.p2, name: updated[matchId].winner, score: 0 };
