...
export default function SixTeamBracket() {
    ...
    const applyTeams = () => {
        ...
        // Round 1
        updated.R1A.p1.name = teamsInput[2] || "TBD";
        updated.R1A.p2.name = teamsInput[5] || "TBD";
        ...
        updated.SF2.p1.name = teamsInput[1] || "TBD"; // Team 2 bye
        updated.SF2.p2.name = "TBD"; // Winner R1B
        setMatches(updated);
        setChampion(null);
    };
    ...
    const handleClick = (matchId, playerKey) => {
        ...
        if (m.p1.name !== "TBD" && m.p2.name !== "TBD" && m.p1.score !== m.p2.score) {
            ...
            if (matchId === "R1A") updated.SF1.p2.name = m.winner;
            else if (matchId === "R1B") updated.SF2.p2.name = m.winner;
    ...
    return (
        <div className="bg-gray-900 min-h-screen p-6 text-white">
            <h1 className="text-2xl font-bold text-center mb-6">6-Team Bracket</h1>
