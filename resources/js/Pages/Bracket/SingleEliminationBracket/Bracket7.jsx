...
export default function SevenTeamBracket() {
    ...
    const handleClick = (matchId, playerKey) => {
        ...
        if (m.p1.name !== "TBD" && m.p2.name !== "TBD" && m.p1.score !== m.p2.score) {
            ...
            else if (matchId === "R1B") updated.SF2.p1.name = m.winner;
            else if (matchId === "R1C") updated.SF2.p2.name = m.winner;
    ...
    return (
        <div className="bg-gray-900 min-h-screen p-6 text-white">
            <h1 className="text-2xl font-bold text-center mb-6">7-Team Bracket</h1>
